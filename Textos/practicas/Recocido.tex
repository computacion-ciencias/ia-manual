...
El pseudocódigo de este algoritmo es descrito en el libro de  \cite{Russell2010} en la sección de algoritmos de mejoramiento iterativo y lo podemos ver en el \pref{alg:annealing}.
...
El código fuente se encuentra en los archivos: \code{Solución.java}, que se encargará de representar una ruta del agente viajero que pase por todas las ciudades, y el archivo \code{RecocidoSimulado.java}, que implementará el algoritmo anteriormente descrito.
