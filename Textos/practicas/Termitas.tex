...
Los resultados anteriores son reportados por el propio Resnick, sin embargo, para mostrar que es posible llegar al mismo resultado.  Para reproducir su experimento haremos uso del lenguaje de programación \Java, pero nos auxiliaremos de la biblioteca \code{core.jar} del lenguaje \code{Processing}\footnote{\hurl{https://processing.org/}}.  Esto nos permitirá crear el ambiente gráfico al heredar de la clase
\begin{center}
...
La clase \code{Termitas}, que extiende \code{PApplet}, sobreescribe tres métodos:
\begin{itemize}
