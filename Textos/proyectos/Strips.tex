...
\begin{compactitem}
 \item Que el alumno se familiarice con el uso del Lenguaje de Definición de Dominios de Planeación (PDDL) para expresar
...
\begin{itemize}
 \item Una copia de la gramática en forma  Forma de Backus-Nau (BNF) del lenguaje para descripción de problemas de planeación PDDL.
