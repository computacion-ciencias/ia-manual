...
\usepackage[cache=false]{minted}            % Requirió reconfigurar Kile para compilar con pdflatex --shell-escape yourfile.tex
...
\input{practicas/TiroParabolico}
...
\input{practicas/InferenciasFactor}
...
\input{proyectos/Strips}


\chapter{Ajedrez}
\chapterauthor{Verónica Esther Arriola Ríos}

\input{proyectos/Ajedrez}


\chapter{Lego Mindstorms}
\chapterauthor{Luis Alfredo Lizárraga Santos}

\input{proyectos/LegoMindstorm}
